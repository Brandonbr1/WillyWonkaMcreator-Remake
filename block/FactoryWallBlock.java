...
public class FactoryWallBlock extends WillywonkaModElements.ModElement {
	@ObjectHolder("willywonka:factory_wall")
	public static final Block block = null;

	public FactoryWallBlock(WillywonkaModElements instance) {
		super(instance, 66);
	}
