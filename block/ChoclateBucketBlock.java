...
public class ChoclateBucketBlock extends WillywonkaModElements.ModElement {
	@ObjectHolder("willywonka:choclate_bucket")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("willywonka:choclate_bucket_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public ChoclateBucketBlock(WillywonkaModElements instance) {
		super(instance, 1);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes
						.builder(new ResourceLocation("willywonka:blocks/choclate_bucket"), new ResourceLocation("willywonka:blocks/choclate_bucket"))
		...
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("choclate_bucket");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("choclate_bucket_flowing");
		elements.blocks
