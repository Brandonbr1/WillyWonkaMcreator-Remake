...
public class CandyGrassBlock extends WillywonkaModElements.ModElement {
	@ObjectHolder("willywonka:candy_grass")
	public static final Block block = null;

	public CandyGrassBlock(WillywonkaModElements instance) {
		super(instance, 21);
	}
