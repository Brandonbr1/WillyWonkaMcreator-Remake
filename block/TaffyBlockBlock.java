...
public class TaffyBlockBlock extends WillywonkaModElements.ModElement {
	@ObjectHolder("willywonka:taffy_block")
	public static final Block block = null;

	public TaffyBlockBlock(WillywonkaModElements instance) {
		super(instance, 13);
	}
