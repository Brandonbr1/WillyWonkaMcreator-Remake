...
public class RockcandyBlock extends WillywonkaModElements.ModElement {
	@ObjectHolder("willywonka:rockcandy")
	public static final Block block = null;

	public RockcandyBlock(WillywonkaModElements instance) {
		super(instance, 75);
	}
