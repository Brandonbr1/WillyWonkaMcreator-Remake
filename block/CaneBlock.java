...
import net.mcreator.willywonka.procedures.CaneBlockDestroyedByPlayerProcedure;
...
public class CaneBlock extends WillywonkaModElements.ModElement {
	@ObjectHolder("willywonka:cane")
	public static final Block block = null;

	public CaneBlock(WillywonkaModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			CaneBlockDestroyedByPlayerProcedure.executeProcedure(Collections.emptyMap());
			return retval;
		}
	}
}
