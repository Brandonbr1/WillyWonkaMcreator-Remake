...
import net.mcreator.willywonka.item.CandyAppleItem;
...
public class AppleBlockCherrySugarBlock extends WillywonkaModElements.ModElement {
	@ObjectHolder("willywonka:apple_block_cherry_sugar")
	public static final Block block = null;

	public AppleBlockCherrySugarBlock(WillywonkaModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("apple_block_cherry_sugar");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CandyAppleItem.block));
		}
	}
}
