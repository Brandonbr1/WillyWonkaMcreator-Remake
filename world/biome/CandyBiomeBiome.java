...
package net.mcreator.willywonka.world.biome;
...
public class CandyBiomeBiome extends WillywonkaModElements.ModElement {
	public static Biome biome;

	public CandyBiomeBiome(WillywonkaModElements instance) {
		super(instance, 42);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(LollyPopBlockBlock.block.getDefaultState(),
								TaffyBlockBlock.block.getDefaultState(), ChoclateBucketBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("willywonka:candy_biome"));
			}
		}
	}
