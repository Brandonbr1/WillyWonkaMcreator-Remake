...
public class GummyBearItem extends WillywonkaModElements.ModElement {
	@ObjectHolder("willywonka:gummy_bear")
	public static final Item block = null;

	public GummyBearItem(WillywonkaModElements instance) {
		super(instance, 18);
	}
