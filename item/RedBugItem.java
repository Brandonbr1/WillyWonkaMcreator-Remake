...
public class RedBugItem extends WillywonkaModElements.ModElement {
	@ObjectHolder("willywonka:red_bug")
	public static final Item block = null;

	public RedBugItem(WillywonkaModElements instance) {
		super(instance, 52);
	}
