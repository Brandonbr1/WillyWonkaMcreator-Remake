...
public class EdibleGrassItemItem extends WillywonkaModElements.ModElement {
	@ObjectHolder("willywonka:edible_grass_item")
	public static final Item block = null;

	public EdibleGrassItemItem(WillywonkaModElements instance) {
		super(instance, 11);
	}
		...
		public ItemCustom() {
			super(new Item.Properties().group(WillyWonkaItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(4).saturation(0.3f)
							...
							.build()));
			setRegistryName("edible_grass_item");
		}
